      ...
      <tr>
        <td className="film-detail-name">
          <input
            type="checkbox"
            checked={isSelected}
            onChange={(e) => this.changeDetail("is_selected", e.target.checked)}
          />{" "}
          {itemName}
        </td>
        {renderOption.map((opt) => {
          if (itemDetail.hasOwnProperty(opt)) {
            return (
              <td>
                <input
                  type="checkbox"
                  checked={itemDetail[opt]}
                  onChange={(e) => this.changeDetail(opt, e.target.checked)}
                />
              </td>
            );
          } else {
        ...
        {/* {itemDetail.hasOwnProperty("is_dev") && (
          <td>
            <input
              type="checkbox"
              checked={isDevelop}
        ...
        {/* {itemDetail.hasOwnProperty("is_scan") && (
          <td>
            <input
              type="checkbox"
              checked={isScan}
        ...
        {itemDetail.hasOwnProperty("is_border") && (
          <td>
            <input
              type="checkbox"
              checked={isBorder}
